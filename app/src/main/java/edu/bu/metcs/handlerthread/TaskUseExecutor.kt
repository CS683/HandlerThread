...
class TaskUseExecutor {
    ...
    private val executor1: Executor = Executors.newSingleThreadExecutor() // change according to your requirements
    ...
    fun executeTask(callback: Callback, delay: Long) {
        executor1.execute { // do something
            ...
            mainHandler.post { callback.updateUI("use executor Done: threadid $threadid i = $i") }
        }
    }
}